...
Love this websocket tool and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/ishuen/binance-ws-ui-tool/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/binance-ws-ui-tool.git
    # Navigate to the newly cloned directory
    cd binance-ws-ui-tool
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/ishuen/binance-ws-ui-tool.git
    ```
...
1. Enable button click to unsubscribe or increase the maximum subscription time to 30 sec.
